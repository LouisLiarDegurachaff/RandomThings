...
import org.louis.randomthings.core.screen.generator.BlockFurnaceGeneratorScreen;
...
public class ModScreens {
    public static void register() {
        ...
        MenuScreens.register(ModMenu.FURNACE_GENERATOR.get(), BlockFurnaceGeneratorScreen::new);
    }
}
